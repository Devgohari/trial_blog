...
function Footer() {
    let elements = ['FAQ', 'Configuration', 'Github', 'LinkedIn',]
    return (
        <>
            <footer className="bottom-0 bg-white dark:bg-gray-800  py-8 mb-0 inset-x-0">
                <div className="max-w-screen-xl mx-auto px-4">
                    <ul className="max-w-screen-md mx-auto text-lg font-light flex flex-wrap justify-between">
                        {
                            elements.map((element) => {
                                return (
                                    <a className="my-2" key={element}>
                                        <p className="text-gray-400 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="#">
                                            {element}
                                        </p>
                                    </a>
                                )
